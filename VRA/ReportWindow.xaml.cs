        ...
        private void FillCollection()
        {
            ...
            if (radioSales.IsChecked != null && radioSales.IsChecked.Value)
            {
                if (radioDay.IsChecked != null && radioDay.IsChecked.Value)
                {
                   ...
                   (Convert.ToDateTime(datePicker2.Text)).Subtract(Convert.ToDateTime(datePicker1.Text));
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetSaled("day", Convert.ToDateTime(datePicker1.Text),
                ...
                if (radioMounth.IsChecked != null && radioMounth.IsChecked.Value)
                {
                   ...
                   (Convert.ToDateTime(datePicker2.Text)).Subtract(Convert.ToDateTime(datePicker1.Text));
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetSaled("month", Convert.ToDateTime(datePicker1.Text),
                    Convert.ToDateTime(datePicker2.Text));
                }
                if (radioYear.IsChecked != null && radioYear.IsChecked.Value)
                {
                   ...
                   (Convert.ToDateTime(datePicker2.Text)).Subtract(Convert.ToDateTime(datePicker1.Text));
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetSaled("year", Convert.ToDateTime(datePicker1.Text),
                    Convert.ToDateTime(datePicker2.Text));
                }
            ...
            if (radioPurchase.IsChecked != null && radioPurchase.IsChecked.Value)
            {
                if (radioDay.IsChecked != null && radioDay.IsChecked.Value)
                {
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetPurchased("day", Convert.ToDateTime(datePicker1.Text),
                    Convert.ToDateTime(datePicker2.Text));
                }
                if (radioMounth.IsChecked != null && radioMounth.IsChecked.Value)
                {
                   ...
                   (Convert.ToDateTime(datePicker2.Text)).Subtract(Convert.ToDateTime(datePicker1.Text));
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetPurchased("month", Convert.ToDateTime(datePicker1.Text),
                    Convert.ToDateTime(datePicker2.Text));
                }
                if (radioYear.IsChecked != null && radioYear.IsChecked.Value)
                {
                   ...
                   (Convert.ToDateTime(datePicker2.Text)).Subtract(Convert.ToDateTime(datePicker1.Text));
                    ...
                    collection.Clear();
                    collection = ProcessFactory.GetReportProcess().GetPurchased("year", Convert.ToDateTime(datePicker1.Text),
                    Convert.ToDateTime(datePicker2.Text));
                }
                // Заполнение коллекции проданных.
                foreach (var item in collection)
